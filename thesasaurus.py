...
b = Button(window, text="Enter", command=update_window, width=20)
b.grid(row=4, column=2, columnspan=4)
b_y = Button(window, text="Yes")
b_n = Button(window, text="No")

e_value = StringVar()
e = Entry(window, textvariable=e_value, width=30)
e.grid(row=1, column=2, columnspan=4)

t = Listbox(window, width=40, height=10)
t.grid(row=2, column=1, columnspan=6)

sc = Scrollbar(window, orient="horizontal")
sc.grid(row=3, column=1, columnspan=6)
...
la.grid(row=0, column=3, columnspan=2)
